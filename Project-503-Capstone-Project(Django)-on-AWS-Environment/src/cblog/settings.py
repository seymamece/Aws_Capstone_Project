...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/seyma/capstone/username')
    password_param = ssm.get_parameter(Name="/seyma/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cxl2hz5xzcuc.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'seymacapstonestatic' # please enter your s3 bucket name
